  ...
  const getTranslatedTitle = (title, language) => {
    const translations = {
      'Bharatiya Nyaya Sanhita': {
        'Telugu': 'భారతీయ న్యాయ సంహిత',
        'Hindi': 'भारतीय न्याय संहिता',
      },
      'Bharatiya Nagarik Suraksha Sanhita ': {
        'Telugu': 'భారతీయ నాగరిక్ సురక్ష సంహిత',
        'Hindi': 'भारतीय नागरिक सुरक्षा संहिता',
      },
      'Bharatiya Sakshya Adhiniyam ': {
        'Telugu': 'భారతీయ సాక్ష్యా అధినీయం',
        'Hindi': 'भारतीय साक्षात् अधिनियमम्',
      },
      'Punishment Increased': {
        'Telugu': 'శిక్ష పెరిగింది',
        'Hindi': 'सज़ा बढ़ा दी गई',
      },
