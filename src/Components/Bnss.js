...
<div className='bnsp1'>
    <p className='bnsp2'><span><FaCalendar />    </span>July 4, 2024<span style={{fontSize:"30px",position:"relative",top:"8px"}}><RxDividerVertical />    </span>  
...
<p className={selectedLanguage === 'Telugu' ? 'bnsp78-telugu' : selectedLanguage === 'Hindi'? 'bnsp78-telugu' : 'bnsp78'}>
{selectedLanguage === 'English'
  ? `
  ...
  : 'छीनना एक अलग अपराध के रूप में'} 
    ...
    <p className={selectedLanguage === 'Telugu' ? 'bnsp78-telugu'  : 'bnsp78'}>
  ...
  : 'मॉब लिंचिंग से संबंधित प्रावधान'}  </h4>
    <p className='bnsp78'>
    {selectedLanguage === 'English'
